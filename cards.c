...
char** getcard(int cnum) {
	...
	switch (cnum) {
		...
		case 5:
			sprintf(card[0],"\u250C-----\u2510");
			//sprintf(card[1],"\u25025    \u2502");
			sprintf(card[1],"%s%s%s%s%s","\u25025",s," ",s," \u2502");
			sprintf(card[2],"\u2502     \u2502");
			//sprintf(card[3],"\u2502  \u2665  \u2502");
			sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
			sprintf(card[4],"\u2502     \u2502");
		...
		case 6:
			sprintf(card[0],"\u250C-----\u2510");
			//sprintf(card[1],"\u25026    \u2502");
			sprintf(card[1],"%s%s%s%s%s","\u25026",s," ",s," \u2502");
			sprintf(card[2],"\u2502     \u2502");
			//sprintf(card[3],"\u2502  \u2665  \u2502");
			//sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
		...
		case 7:
			sprintf(card[0],"\u250C-----\u2510");
			//sprintf(card[1],"\u25027    \u2502");
			sprintf(card[1],"%s%s%s%s%s","\u25027",s," ",s," \u2502");
			sprintf(card[2],"\u2502     \u2502");
			//sprintf(card[3],"\u2502  \u2665  \u2502");
			//sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
			sprintf(card[3],"%s%s%s%s%s","\u2502 ",s,s,s," \u2502");
			sprintf(card[4],"\u2502     \u2502");
			//sprintf(card[5],"\u2502     \u2502");
			sprintf(card[5],"%s%s%s%s%s","\u2502 ",s," ",s," \u2502");
			sprintf(card[6],"\u2502    7\u2502");
		...
		case 8:
			sprintf(card[0],"\u250C-----\u2510");
			//sprintf(card[1],"\u25026    \u2502");
			sprintf(card[1],"%s%s%s%s%s","\u25028",s," ",s," \u2502");
			//sprintf(card[2],"\u2502     \u2502");
			sprintf(card[2],"%s%s%s","\u2502  ",s,"  \u2502");
			//sprintf(card[3],"\u2502  \u2665  \u2502");
			//sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
		...
		case 9:
			sprintf(card[0],"\u250C-----\u2510");
			//sprintf(card[1],"\u25029    \u2502");
			sprintf(card[1],"%s%s%s%s%s","\u25029",s," ",s," \u2502");
			sprintf(card[2],"%s%s%s%s%s","\u2502 ",s," ",s," \u2502");
			//sprintf(card[4],"\u2502     \u2502");
			sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
		...
		case 10:
			...
			//sprintf(card[3],"%s%s%s","\u2502  ",s,"  \u2502");
			sprintf(card[3],"%s%s%s%s%s","\u2502 ",s,s,s," \u2502");
			sprintf(card[4],"%s%s%s%s%s","\u2502 ",s,s,s," \u2502");
			sprintf(card[5],"%s%s%s%s%s","\u2502 ",s," ",s," \u2502");
			//sprintf(card[6],"%s%s%s%s%s","\u2502",s," ",s,"10\u2502");
			//sprintf(card[5],"\u2502     \u2502");
			sprintf(card[6],"\u2502   10\u2502");
			sprintf(card[7],"\u2514-----\u2518");
			break;
